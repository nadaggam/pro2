...
export default function AboutUs() {
    ...
    <div className="">
      ...
      >
            ...
            <Carousel className="my-4">
              ...
              <Carousel.Item>
                ...
                <Carousel.Caption>
                  ...
                  <p>
                    Lorem ipsum dolor sit amet,vvvvvvvvv consectetur adipiscing
                    elit.
                  </p>
                </Carousel.Caption>
              </Carousel.Item>
          ...
          <Col className=" h-50 col-xs-12 col-sm-12 col-md-12 col-lg-6">
            <Container className=" m-5 ">
              <Row className="d-flex flex-wrap ">
                <Col className=" my-5 d-flex justify-content-start h-50 col-xs-12 col-sm-12 col-md-12 col-lg-12 my-3 ">
                  
                  <h2>Contact Us</h2>
                </Col>
                <Col className=" d-flex justify-content-start  my-2 h-50 col-xs-12 col-sm-12 col-md-12 col-lg-12 ">
                  <a
                    title="call us"
        ...
        <Row className="my-5 d-flex flex-wrap  ">
          ...
          <Col className="  h-50 col-xs-12 col-sm-12 col-md-12 col-lg-6">
          <Row> <label htmlFor=""> <b>sheare your feedback with us</b> </label>
            <br />
  ...
  <button  className="btn btn-outline-success" type="submit">sheare</button>
</form>
<table >
