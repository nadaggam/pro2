...
let formOperation = (e) => {
 ...
 let OperationHandler = (e) => {
  ...
  <input onChange={OperationHandler} type="text" className="form-control" defaultValue={
    product.img1} name="img1" placeholder="Enter url for image" accept="image/*"/> 
    <input onChange={OperationHandler} type="text" className="form-control" defaultValue={
    product.img2} name="img2" placeholder="Enter url for image" accept="image/*"/> 
    <input onChange={OperationHandler} type="text" className="form-control" defaultValue={
    product.img3} name="img3" placeholder="Enter url for image" accept="image/*"/>   </div>
   <div className="mb-3">
